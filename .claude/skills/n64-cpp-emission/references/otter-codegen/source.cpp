// Canonical Otter bodies consumed by the adjacent gen_otter.py reference harness.
// Edit function bodies here; use the generator to decide where they are emitted.
